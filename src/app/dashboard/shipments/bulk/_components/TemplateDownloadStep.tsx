        ...
        {[
          {
            ...
            desc: 'Abre el archivo .xlsx en Excel. Verás la hoja "Envíos" para registrar tu data y "Catálogo" como referencia de cobertura.',
            color: 'blue',
          },
          {
            step: '2',
            icon: <BookOpen className="w-3.5 h-3.5" />,
            title: 'Ingresa las ubicaciones',
            desc: 'Escribe el nombre del Distrito o Sector en la columna D. Las columnas celestes (E, F, G) confirmarán la ubicación exacta automáticamente.',
            color: 'amber',
          },
          {
            step: '3',
            ...
            desc: 'Al terminar, guarda el archivo sin cambiar el formato (.xlsx) para el siguiente paso.',
            color: 'emerald',
          },
        ].map((item) => (
          <div
